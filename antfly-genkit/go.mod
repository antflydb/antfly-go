...
require (
	github.com/antflydb/antfly-go/antfly v0.0.0-20260303003844-110c235df183
...
require (
	github.com/antflydb/antfly-go/libaf v0.0.0-20260303003844-110c235df183 // indirect
