...
require (
	github.com/antflydb/antfly-go/antfly v0.0.0-20260304202045-da53f6505f4a
...
require (
	github.com/antflydb/antfly-go/libaf v0.0.0-20260304202045-da53f6505f4a // indirect
