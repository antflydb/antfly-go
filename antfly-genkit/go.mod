...
require (
	github.com/antflydb/antfly-go/antfly v0.0.0-20251213002611-2a4513d3211c
...
require (
	...
	github.com/kaptinlin/jsonpointer v0.4.7 // indirect
	github.com/kaptinlin/jsonschema v0.6.3 // indirect
