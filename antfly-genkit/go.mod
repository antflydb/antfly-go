...
require (
	github.com/antflydb/antfly-go/antfly v0.0.0-20260105234922-f6ed1eb6788d
...
require (
	github.com/antflydb/antfly-go/libaf v0.0.0-20260119040111-36db55706c38 // indirect
